import { z } from "zod";
import { encodeFunctionData, type Abi, AbiFunctionNotFoundError } from "viem";
import type { AgentkitAction } from "../agentkit"; // Adjust path if necessary
...
export class EncodeFunctionDataAction
	implements AgentkitAction<typeof EncodeFunctionDataSchema>
{
